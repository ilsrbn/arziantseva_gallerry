          ...
          <v-col cols="12" md="4">
            <v-dialog width="500">
              ...
              <v-card :disabled="loading" :loading="loading">
                ...
                <v-card-subtitle>Enter Post title</v-card-subtitle>
                <v-card-text>
                  <v-form v-model="post.valid">
                    <v-text-field
                      v-model="post.title"
                      required
                      :rules="post.rules"
                ...
                <v-card-actions>
                  <v-btn :loading="loading" :disabled="loading" rounded color="green" @click="createPost()">
                    Create Post <v-icon right>
                      mdi-plus
                    </v-icon>
                  </v-btn>
  ...
  methods: {
    ...
    async createPost () {
      ...
      try {
        ...
        await this.$router.push(`/admin/posts/${resp.id}`)
    ...
    viewItem (index) {
      this.$router.push('/admin/posts/' + index)
    },
